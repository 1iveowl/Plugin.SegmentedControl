...
namespace SegCtrl
{
    ...
    public class SegmentedControl : View, ISegmentedControl
    {
        ...
        private static void OnChildrenChanging(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            {
                segmentedControl.OnElementChildrenChanging?.Invoke(
                    segmentedControl, 
                    new ElementChildrenChanging((IList<SegmentedControlOption>)oldValue, newItemsList));
        ...
        private void OnItemsSourceChanged()
        {
            ...
            if (items is null && itemsSource is IEnumerable list)
            {
            ...
            if (items is not null)
            {
                ...
                if (textValues != null)
                {
                    Children = new List<SegmentedControlOption>(textValues
                        .Select(child => new SegmentedControlOption { Text = child }));
                ...
                else
                {
                    ...
                    if (textPropertyName is not null)
                    {
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            switch (propertyName)
            {
                ...
                case nameof(SelectedSegment):
                    ...
                    break;
                //default:
                    //throw new InvalidEnumArgumentException(propertyName);
            }
        }
        ...
        private void OnSelectedSegmentChanged()
        {
            ...
            if (segmentIndex >= 0 
                && segmentIndex < Children.Count 
                && SelectedItem != Children[segmentIndex].Item)
            {
                SelectedItem = (SegmentedControlOption)Children[segmentIndex].Item;
            }                
        }
        ...
        public static readonly BindableProperty TintColorProperty = 
            BindableProperty.Create(
                nameof(TintColor), 
                typeof(Color), 
                typeof(SegmentedControl), Colors.Blue);
        ...
        public static readonly BindableProperty SelectedTextColorProperty = 
            BindableProperty.Create(
                ...
                typeof(Color), 
                typeof(SegmentedControl), Colors.White);
        ...
        public static readonly BindableProperty BorderWidthProperty = 
            BindableProperty.Create(
                ...
                typeof(double), 
                typeof(SegmentedControl), 
                defaultValueCreator: _ => DeviceInfo.Platform == DevicePlatform.Android 
                    ? 1.0 
                    : 0.0);
        ...
        public SegmentedControlOption SelectedItem
        {
            get => (SegmentedControlOption)GetValue(SelectedItemProperty);
        ...
        {
            throw new NotImplementedException($"Completed not implemented{nameof(SegmentedControl)}");
        }
    }
}
